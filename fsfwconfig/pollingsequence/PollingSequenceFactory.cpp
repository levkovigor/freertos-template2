...
ReturnValue_t pst::pollingSequenceInitRS485(FixedTimeslotTaskIF *thisSequence) {
    ...
    thisSequence->addSlot(objects::RS485_DEVICE_COM_IF,  0.072,
            RS485Timeslot::PCDU_VORAGO);
    thisSequence->addSlot(objects::RS485_DEVICE_COM_IF, 0.079,
            RS485Timeslot::PL_VORAGO);
    thisSequence->addSlot(objects::RS485_DEVICE_COM_IF, 0.086,
