...
static const sid_t TEST_SET_DEV_0_SID = sid_t(objects::DUMMY_HANDLER_0, TEST_SET_ID);
static const sid_t TEST_SET_DEV_1_SID = sid_t(objects::DUMMY_HANDLER_1, TEST_SET_ID);
