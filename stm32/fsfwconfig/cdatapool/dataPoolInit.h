#ifndef CONFIG_DATAPOOL_DATAPOOLINIT_H_
#define CONFIG_DATAPOOL_DATAPOOLINIT_H_
...
namespace datapool{
	...
	enum datapoolvariables {
		...
		/** [EXPORT] : [GROUP] TEST */
		TEST_BOOLEAN = 0x01010101, 				//!< [EXPORT] : [NAME] Test Boolean [UNIT] (-) [SIZE] 1 [TYPE] bool
		TEST_UINT8 = 0x02020202,				//!< [EXPORT] : [NAME] Test Byte [UNIT] (-) [SIZE] 1 [TYPE] uint8_t
		TEST_UINT16 = 0x03030303,				//!< [EXPORT] : [NAME] Test UINT16 [UNIT] (-) [SIZE] 1 [TYPE] uint16_t
		TEST_UINT32 = 0x04040404,				//!< [EXPORT] : [NAME] Test UINT32 [UNIT] (-) [SIZE] 1 [TYPE] uint32_t
		TEST_FLOAT_VECTOR = 0x05050505			//!< [EXPORT] : [NAME] Test Float [UNIT] (-) [SIZE] 2 [TYPE] float
	};
}
#endif /* CONFIG_DATAPOOL_DATAPOOLINIT_H_ */
