...
USLPTransferFrame* UslpVirtualChannel::multiplexFrameMap(uint8_t *inputBuffer, size_t inputSize,
    ...
    USLPTransferFrame*  returnFrame = (iter->second)->packFrame(inputBuffer, inputSize, outputBuffer, outputSize, tfdzSize);
