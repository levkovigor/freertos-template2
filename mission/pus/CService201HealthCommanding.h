#ifndef MISSION_PUS_CSERVICE201HEALTHCOMMANDING_H_
#define MISSION_PUS_CSERVICE201HEALTHCOMMANDING_H_

#include <fsfw/tmtcservices/CommandingServiceBase.h>

/**
 * @brief Custom PUS service to set health of all objects implementing hasHealthIF.
 *
 ...
 * This service is very closely tied to the Commanding Service Base template class.
...
public:
	CService201HealthCommanding(object_id_t objectId_);
...
#endif /* MISSION_PUS_CSERVICE201HEALTHCOMMANDING_H_ */
