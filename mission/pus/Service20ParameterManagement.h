#ifndef MISSION_PUS_SERVICE20PARAMETERMANAGEMENT_H_
#define MISSION_PUS_SERVICE20PARAMETERMANAGEMENT_H_
...
{
public:
	Service20ParameterManagement(object_id_t objectId_);
...
#endif /* MISSION_PUS_SERVICE20PARAMETERMANAGEMENT_H_ */
