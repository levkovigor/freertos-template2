...
// Note(Robin): We propably should tweak this, our main bus is RS485 (UART2)
// and Iridium is connected to UART0 so these should propably have a high
// priority.

// There are 8 priority levels, lowest = 0 = AT91C_AIC_PRIOR_LOWEST and
// highest = 7 = AT91C_AIC_PRIOR_HIGHEST
