...
void DEMO_SD_FileTasks( int volID )
{
	...
	xTaskGenericCreate( _TaskTestFileLogWrite, (const char*)"TestFileLogWrite", 4096, NULL, configMAX_PRIORITIES-2, &_task[0], NULL, NULL);
	xTaskGenericCreate( _TaskTestFileLogRead,  (const char*)"TestFileLogRead", 4096, NULL, configMAX_PRIORITIES-3, &_task[1], NULL, NULL);
