...
extern void vApplicationTickHook( void ); // @suppress("Unused function declaration")
...
/*-----------------------------------------------------------*/
	...
	const tskTCB * const pxTCB = ( tskTCB * ) xTask;
		...
		if( pxTCB == pxCurrentTCB )
		{
			...
			eReturn = eRunning; // @suppress("Symbol is not resolved")
		}
		else
		{
			taskENTER_CRITICAL();
			...
			if( ( pxStateList == pxDelayedTaskList ) || ( pxStateList == pxOverflowDelayedTaskList ) )
			{
				...
				lists. */
				eReturn = eBlocked; // @suppress("Symbol is not resolved")
			}
				...
				else if( pxStateList == &xSuspendedTaskList )
				{
					...
					list. */
					eReturn = eSuspended; // @suppress("Symbol is not resolved")
				}
			#endif
				...
				else if( pxStateList == &xTasksWaitingTermination )
				{
					...
					tasks list. */
					eReturn = eDeleted; // @suppress("Symbol is not resolved")
				}
			#endif
			...
			else
			{
				...
				eReturn = eReady; // @suppress("Symbol is not resolved")
			}
		}
